    ...
    <div className="welcome-container">
      <TypingAnimation text="About Me"></TypingAnimation>
        ...
        <div className="profile-blurb">
          <p>Hi, I’m Sanjana! I’m an undergraduate student at UNC Chapel Hill, double majoring in computer science and advertising. I'm passionate about technology and branding, and interested in front-end software engineering and product management.</p>
