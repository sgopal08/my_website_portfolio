...
const tiles = [
  {
    ...
    description:
      'Byte Notes is a note-taking platform for Computer Science students, featuring a markdown text editor and built-in code compiler. Users can organize notes by notebooks, chapters, and pages, and share and publish them for other users. ',
  ...
  },
  {
    ...
    description:
      'An AI-powered office hour summary & analytics page. Created as a feature for the UNC Computer Science department website to aid professors and teaching assistants.',
  ...
  },
  {
    ...
    description:
      'A product ingredient scanner app that helps users quickly identify potentially harmful or allergy-triggering ingredients in skincare, makeup, and personal care products—especially those hidden in hard-to-read labels.',
  ...
  },
  {
    ...
    description:
      'High-fidelity design wireframes for a volunteer, crowd-sourcing, and community forum platform to motivate street garbage clean-ups in Bangalore, India. Users can sign-up for neighborhood cleans ups, donate directly to the cause to fund equipment & volunteer needs, and share progress via a community forum.',
    ...
    presentationLink:
      'https://docs.google.com/presentation/d/1_RqGRpBQ1FqGgb0cn5hHbGl-rbhbZMkCk5zSlrnWoXg/edit?usp=sharing',
  },
  {
    ...
    software: ['Swift'],
    description:
      'UNC Chapel Hill-based roommate matching app. Users can swipe through other profiles to find a roommate match. Created for PearlHacks 2024.',
  ...
  },
  {
    ...
    description:
      'Personal Portfolio website platform where users can view my experiences, projects, and get in touch with me.',
  ...
  // },
  {
    ...
    software: ['Swift'],
    description:
      'An iOS app recreation of the New York Times Mini Crossword game.',
  ...
  },
  {
    ...
    description:
      "A website to help working mothers find affordable, reliable childcare with personalized options, prices, and ratings. Created for Fidelity Investments' Hackathon 2024. ",
